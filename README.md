...
```
python -m pip install -i https://test.pypi.org/simple/ sportsrefscraper==0.1.6
```
...
_More Questions? See the [FAQ](https://github.com/josh-bone/sportsrefscraper/blob/main/faq/README.md)_
